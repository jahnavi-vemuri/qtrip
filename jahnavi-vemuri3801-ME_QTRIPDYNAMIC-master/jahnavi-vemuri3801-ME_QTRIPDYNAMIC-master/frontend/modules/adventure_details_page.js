...
function addAdventureDetailsToDOM(adventure) {
  ...
  for(let i=0;i<adventure.images.length;i++){
    ...
    b.src=adventure.images[i];
    b.setAttribute("class","activity-card-image");
    a.append(b);
    photos.append(a);
  }
...
function addBootstrapPhotoGallery(images) {
  ...
  let a=document.getElementById("photo-gallery")
  let b=
...
a.innerHTML=b;
let c=document.getElementById("carousel-inner");
